...
path_counts_name <- paste0(release,"20231023_v3/review-counts_name_rounded.csv")
path_counts_term <- paste0(release,"20231023_v3/review-counts_term_rounded.csv")
path_failures <- paste0(release,"20231023_v3/review-failures.csv")
path_model_output <- paste0(release,"20231023_v3/review-model_output_rounded.csv")
path_stata_model_output <- paste0(release,"20231031/stata_model_output_rounded.csv")