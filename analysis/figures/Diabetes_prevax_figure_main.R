...
dir <- "C:/Users/gic30/OneDrive - University of Cambridge/2. Long Covid/Code/post-covid-unvaccinated - figures DM - 2022.07/"
setwd(dir)

results_dir <- "/Users/gic30/OneDrive - University of Cambridge/2. Long Covid/Code/post-covid-unvaccinated - figures DM - 2022.07/"
output_dir <- "/Users/gic30/OneDrive - University of Cambridge/2. Long Covid/Code/post-covid-unvaccinated - figures DM - 2022.07/figures/"
...
for(c in cohort){
  for (group in unique(main_estimates$outcome_group)) {
    ...
    ggplot2::ggsave(paste0(output_dir,outcome_name,"_",c,"_figure_main.png"), height = 297, width = 210, unit = "mm", dpi = 600, scale = 1)
  }
}

# Figure with all 4 diabetes outcomes
for(c in cohort){
  ...
  ggplot2::ggsave(paste0(output_dir,outcome_name,"_",c,"_figure_main_all.png"), height = 297, width = 210, unit = "mm", dpi = 600, scale = 1)
}